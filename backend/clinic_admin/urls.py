...
urlpatterns = [
    ...
    path(
        'patients/<int:pk>/book/',
        views.PatientBookView.as_view(),
        name='patient_book'
    ),
    ...
    path(
        'families/<int:pk>/add-member/',
        views.FamilyAddMemberView.as_view(),
        name='family_add_member'
    ),
    path(
        'families/<int:pk>/remove-member/',
        views.FamilyRemoveMemberView.as_view(),
    ...
    path(
        'schedule/',
        views.ClinicScheduleView.as_view(),
        name='clinic_schedule'
    ),
    path(
        'appointments/update-status/',
        views.AppointmentUpdateStatusView.as_view(),
        name='appointment_update_status'
    ),
    path(
        'appointments/<int:pk>/results/',
        views.AppointmentResultsView.as_view(),
